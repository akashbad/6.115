...
/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_Start
********************************************************************************
*
* Summary:
...
void ADC_Ext_CP_Clk_Start(void) 
{
    ...
    ADC_Ext_CP_Clk_CLKEN |= ADC_Ext_CP_Clk_CLKEN_MASK;
	ADC_Ext_CP_Clk_CLKSTBY |= ADC_Ext_CP_Clk_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_Stop
********************************************************************************
*
* Summary:
...
void ADC_Ext_CP_Clk_Stop(void) 
{
    ...
    ADC_Ext_CP_Clk_CLKEN &= (uint8)(~ADC_Ext_CP_Clk_CLKEN_MASK);
	ADC_Ext_CP_Clk_CLKSTBY &= (uint8)(~ADC_Ext_CP_Clk_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((ADC_Ext_CP_Clk_CLKEN & ADC_Ext_CP_Clk_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = ADC_Ext_CP_Clk_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ADC_Ext_CP_Clk_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* ADC_Ext_CP_Clk__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(ADC_Ext_CP_Clk_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(ADC_Ext_CP_Clk_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ADC_Ext_CP_Clk_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = ADC_Ext_CP_Clk_GetSourceRegister();
    uint16 oldDivider = ADC_Ext_CP_Clk_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ADC_Ext_CP_Clk_CLKEN & ADC_Ext_CP_Clk_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(ADC_Ext_CP_Clk_DIV_PTR, clkDivider);
                ADC_Ext_CP_Clk_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                ADC_Ext_CP_Clk_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(ADC_Ext_CP_Clk_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((ADC_Ext_CP_Clk_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(ADC_Ext_CP_Clk_DIV_PTR);
}


/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    ADC_Ext_CP_Clk_MOD_SRC |= modeBitMask & (uint8)ADC_Ext_CP_Clk_MODE_MASK;
}


/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    ADC_Ext_CP_Clk_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(ADC_Ext_CP_Clk_MODE_MASK));
}


/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return ADC_Ext_CP_Clk_MOD_SRC & (uint8)(ADC_Ext_CP_Clk_MODE_MASK);
}


/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = ADC_Ext_CP_Clk_GetDividerRegister();
    uint8 oldSrc = ADC_Ext_CP_Clk_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        ADC_Ext_CP_Clk_MOD_SRC |= CYCLK_SSS;
        ADC_Ext_CP_Clk_MOD_SRC =
            (ADC_Ext_CP_Clk_MOD_SRC & (uint8)(~ADC_Ext_CP_Clk_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return ADC_Ext_CP_Clk_MOD_SRC & ADC_Ext_CP_Clk_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    ADC_Ext_CP_Clk_PHASE = clkPhase & ADC_Ext_CP_Clk_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ADC_Ext_CP_Clk_GetPhase
********************************************************************************
*
* Summary:
...
{
    return ADC_Ext_CP_Clk_PHASE & ADC_Ext_CP_Clk_PHASE_MASK;
}
