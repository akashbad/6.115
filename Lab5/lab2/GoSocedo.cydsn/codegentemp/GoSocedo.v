// ======================================================================
// GoSocedo.v generated from TopDesign.cysch
// 04/14/2014 at 18:52
...
module CharLCD_v1_90_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c8e46d5f-7815-42e9-b41a-993f546b39b6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__LED0_net;
	wire [0:0] tmpFB_0__LED0_net;
	wire [0:0] tmpIO_0__LED0_net;
	wire [0:0] tmpINTERRUPT_0__LED0_net;
	electrical [0:0] tmpSIOVREF__LED0_net;
	...
	cy_psoc3_pins_v1_10
		...
		LED0
		 (.oe(tmpOE__LED0_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__LED0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("cf71f6a8-fdf3-4625-8a9d-d20af395f4cd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4b6fbc38-946f-4ed4-993c-89de18ea5694"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("13e51cd4-29de-44c6-9b90-2058b3e13c69"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4f8fa097-603c-45ac-a7a3-bfdc0423c13f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3a849c63-b175-423f-91e4-11722de5f92f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3037b167-7cd4-422a-9022-cb411aa3a33b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("555a4ea9-677e-4b80-aacf-9ae6fd4713c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PotPin_net;
	wire [0:0] tmpFB_0__PotPin_net;
	wire [0:0] tmpIO_0__PotPin_net;
	wire [0:0] tmpINTERRUPT_0__PotPin_net;
	electrical [0:0] tmpSIOVREF__PotPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .width(1))
		PotPin
		 (.oe(tmpOE__PotPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PotPin_net[0:0]}),
		  .analog({Net_32}),
		  .io({tmpIO_0__PotPin_net[0:0]}),
		  .siovref(tmpSIOVREF__PotPin_net),
		  .interrupt({tmpINTERRUPT_0__PotPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PotPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
