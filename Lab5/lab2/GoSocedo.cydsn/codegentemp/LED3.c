...
{
    uint8 staticBits = (LED3_DR & (uint8)(~LED3_MASK));
    LED3_DR = staticBits | ((uint8)(value << LED3_SHIFT) & LED3_MASK);
}
...
{
	CyPins_SetPinDriveMode(LED3_0, mode);
}
...
{
    return (LED3_PS & LED3_MASK) >> LED3_SHIFT;
}
...
{
    return (LED3_DR & LED3_MASK) >> LED3_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (LED3_INTSTAT & LED3_MASK) >> LED3_SHIFT;
    }
