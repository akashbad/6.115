...
{
    uint8 staticBits = (LED6_DR & (uint8)(~LED6_MASK));
    LED6_DR = staticBits | ((uint8)(value << LED6_SHIFT) & LED6_MASK);
}
...
{
	CyPins_SetPinDriveMode(LED6_0, mode);
}
...
*  
* Note:
*  Macro LED6_ReadPS calls this function. 
*  
*******************************************************************************/
uint8 LED6_Read(void) 
{
    return (LED6_PS & LED6_MASK) >> LED6_SHIFT;
}
...
{
    return (LED6_DR & LED6_MASK) >> LED6_SHIFT;
}


/* If Interrupts Are Enabled for this Pins component */ 
#if defined(LED6_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
        return (LED6_INTSTAT & LED6_MASK) >> LED6_SHIFT;
    }
