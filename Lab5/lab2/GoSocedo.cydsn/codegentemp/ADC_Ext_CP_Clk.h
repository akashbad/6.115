...
#endif /* defined(ADC_Ext_CP_Clk__CFG3) */

#define ADC_Ext_CP_Clk_Enable()                       ADC_Ext_CP_Clk_Start()
#define ADC_Ext_CP_Clk_Disable()                      ADC_Ext_CP_Clk_Stop()
#define ADC_Ext_CP_Clk_SetDivider(clkDivider)         ADC_Ext_CP_Clk_SetDividerRegister(clkDivider, 1u)
#define ADC_Ext_CP_Clk_SetDividerValue(clkDivider)    ADC_Ext_CP_Clk_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define ADC_Ext_CP_Clk_SetPhaseValue(clkPhase)        ADC_Ext_CP_Clk_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(ADC_Ext_CP_Clk__CFG3) */
