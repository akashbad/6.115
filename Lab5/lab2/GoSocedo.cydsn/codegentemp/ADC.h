...
#define ADC_Pot_RESOLUTION         (12u )
#define ADC_Pot_INPUT_RANGE        (0u)
#define ADC_Pot_SRATE              (1000u)
#define ADC_Pot_REFERENCE          (0u)
#define ADC_Pot_BUFFER_GAIN        (1u)
#define ADC_Pot_CONV_MODE          (0u)
#define ADC_Pot_INPUT_RANGE_VALUE  (1.024)
#define ADC_DEFAULT_STROBE                     (1u)
...
/* Default Config
* ADC_Pot Sample Rate: 1000 Samples per Second
* ADC_Pot Conversion Mode: 0
* ADC_Pot Input Buffer Gain: 1
* ADC_Pot Reference: 0
* ADC_Pot Input Range: 0
* ADC_Pot Resolution: 12 bits
* ADC_Pot Clock: 150000 Hz
*/

#define ADC_Pot_DEC_CR             (0x32u)
#define ADC_Pot_DEC_SR             (0x14u)
#define ADC_Pot_DEC_SHIFT1         (0x06u)
#define ADC_Pot_DEC_SHIFT2         (0x08u)
#define ADC_Pot_DEC_DIV            (0)
#define ADC_Pot_DEC_DR2            (0x00u)
#define ADC_Pot_DEC_DR2H           (0x00u)
#define ADC_Pot_DEC_DR1            (0x1Fu)
#define ADC_Pot_DEC_OCOR           (0x00u)
#define ADC_Pot_DEC_OCORM          (0x00u)
#define ADC_Pot_DEC_OCORH          (0x00u)
#define ADC_Pot_DEC_GVAL           (0x0Du)
#define ADC_Pot_DEC_GCOR           (0x00u)
#define ADC_Pot_DEC_GCORH          (0x00u)
#define ADC_Pot_DEC_COHER          (0x01u)
#define ADC_Pot_DSM_CR0            (0x0Au)
#define ADC_Pot_DSM_CR1            (0x00u)
#define ADC_Pot_DSM_CR2            (0x7Au)
#define ADC_Pot_DSM_CR3            (0x00u)
#define ADC_Pot_DSM_CR4            (0x14u)
#define ADC_Pot_DSM_CR5            (0x09u)
#define ADC_Pot_DSM_CR6            (0x0Au)
#define ADC_Pot_DSM_CR7            (0x00u)
#define ADC_Pot_DSM_CR8            (0x12u)
#define ADC_Pot_DSM_CR9            (0x13u)
#define ADC_Pot_DSM_CR10           (0x11u)
#define ADC_Pot_DSM_CR11           (0x12u)
#define ADC_Pot_DSM_CR12           (0x01u)
#define ADC_Pot_DSM_CR13           (0x00u)
#define ADC_Pot_DSM_CR14           (0x00u)
#define ADC_Pot_DSM_CR15           (0x00u)
#define ADC_Pot_DSM_CR16           (0x0Au)
#define ADC_Pot_DSM_CR17           (0x43u)
#define ADC_Pot_DSM_REF0           (0x44u)
#define ADC_Pot_DSM_REF1           (0x00u)
#define ADC_Pot_DSM_REF2           (0x58u)
#define ADC_Pot_DSM_REF3           (0x00u)
#define ADC_Pot_DSM_DEM0           (0x07u)
#define ADC_Pot_DSM_DEM1           (0x00u)
#define ADC_Pot_DSM_MISC           (0x00u)
#define ADC_Pot_DSM_CLK            (0x18u)
#define ADC_Pot_DSM_BUF0           (0x05u)
#define ADC_Pot_DSM_BUF1           (0x02u)
#define ADC_Pot_DSM_BUF2           (0x00u)
#define ADC_Pot_DSM_BUF3           (0x00u)
#define ADC_Pot_DSM_OUT0           (0x00u)
#define ADC_Pot_DSM_OUT1           (0x00u)
#define ADC_Pot_DSM_SW3            (0x40u)
#define ADC_Pot_CLOCKS_PER_SAMPLE  (0x0096u)
#define ADC_Pot_CLOCK_FREQ         (150000u)
#define ADC_Pot_CP_CLOCK_FREQ      (600000u)
#define ADC_Pot_REFERENCE_VOLTAGE  (1.0240)
#define ADC_Pot_COUNTS_PER_VOLT    (4000)
#define ADC_Pot_IDEAL_DEC_GAIN     (0x8DB6u)
#define ADC_Pot_IDEAL_ODDDEC_GAIN  (0x8000u)

#define ADC_Pot_ALIGNMENT          (0u)
#define ADC_Pot_ADC_CLK_DIVIDER    (159u)
#define ADC_Pot_CP_CLK_DIVIDER     (38u)

/* Input and DAC Cap values in pF */
#define ADC_Pot_IPCAP1VALUE        (0x0380u)
#define ADC_Pot_DACAPVALUE         (0x03E0u)

/* Below defines are deprecated and should not be used. These are provided
*   just to keep the component backward compatible
*/
#define ADC_DEFAULT_SRATE                      ADC_Pot_SRATE
#define ADC_CLOCKS_PER_SAMPLE                  ADC_Pot_CLOCKS_PER_SAMPLE
#define ADC_DFLT_CLOCK_FREQ                    ADC_Pot_CLOCK_FREQ
#define ADC_REFERENCE_VOLTAGE                  ADC_Pot_REFERENCE_VOLTAGE
#define ADC_DFLT_COUNTS_PER_VOLT               ADC_Pot_COUNTS_PER_VOLT
#define ADC_DEFAULT_RESOLUTION                 ADC_Pot_RESOLUTION
#define ADC_DEFAULT_CONV_MODE                  ADC_Pot_CONV_MODE
#define ADC_DEFAULT_IDEAL_DEC_GAIN             ADC_Pot_IDEAL_DEC_GAIN
#define ADC_DEFAULT_RANGE                      ADC_Pot_RANGE
#define ADC_DEFAULT_RANGE_VALUE                ADC_Pot_RANGE_VALUE
#define ADC_DEFAULT_REFERENCE                  ADC_Pot_REFERENCE
#define ADC_DEFAULT_BUF_GAIN                   ADC_Pot_BUF_GAIN
#define ADC_Pot_BUF_GAIN           ADC_Pot_BUFFER_GAIN
#define ADC_Pot_RANGE              ADC_Pot_INPUT_RANGE
#define ADC_Pot_RANGE_VALUE        ADC_Pot_INPUT_RANGE_VALUE

/* Input and DAC Cap values in pF */
#define ADC_DEFAULT_IPCAP1VALUE                ADC_Pot_IPCAP1VALUE
#define ADC_DEFAULT_DACAPVALUE                 ADC_Pot_DACAPVALUE
#define ADC_DEFAULT_IDEAL_ODDDEC_GAIN          ADC_Pot_IDEAL_ODDDEC_GAIN
