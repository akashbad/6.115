...
{
    uint8 staticBits = (LED0_DR & (uint8)(~LED0_MASK));
    LED0_DR = staticBits | ((uint8)(value << LED0_SHIFT) & LED0_MASK);
}
...
{
	CyPins_SetPinDriveMode(LED0_0, mode);
}
...
{
    return (LED0_PS & LED0_MASK) >> LED0_SHIFT;
}
...
{
    return (LED0_DR & LED0_MASK) >> LED0_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (LED0_INTSTAT & LED0_MASK) >> LED0_SHIFT;
    }
