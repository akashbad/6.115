...
#define BS_UDB_0_4_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000384u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x4800040Cu)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000414u)
