// ======================================================================
// LauncherController.v generated from TopDesign.cysch
// 05/12/2014 at 16:18
...
module CharLCD_v1_90_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("77467b8e-ba15-47ec-b8c6-6f3c36dd6d62/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=1, CY_COMPONENT_NAME=Comp_v2_0, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=CapSense:CompCH0, CY_INSTANCE_SHORT_NAME=CompCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=CapSense_CompCH0, )
module Comp_v2_0_3 (
    Vplus,
    CmpOut,
    Vminus,
...
// IDAC8_v2_0(Current=0, Data_Source=0, Hardware_Enable=true, IDAC_Range=4, IDAC_Speed=0, Initial_Value=0, Polarity=4, Strobe_Mode=0, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=CapSense:IdacCH0, CY_INSTANCE_SHORT_NAME=IdacCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=CapSense_IdacCH0, )
module IDAC8_v2_0_4 (
    iOut,
    data,
    strobe,
...
module CapSense_CSD_v3_40_5 (
	...
	cy_psoc3_pins_v1_10
		#(.id("45be931e-7364-4235-84a2-75f79122acec/232398c5-3876-4e07-8f5b-7cd7657055e2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_port_v1_0
		#(.width(7),
		  .siorefwidth(4),
		  .id("45be931e-7364-4235-84a2-75f79122acec/dd9c1af8-be5a-4b9e-b10c-b2d9f11dc9fc"),
	...
	cy_clock_v1_0
		#(.id("45be931e-7364-4235-84a2-75f79122acec/0ad1a1a8-974e-43a0-841b-3af08590011d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("45be931e-7364-4235-84a2-75f79122acec/52b807b3-40a8-4a39-b1e7-e18f76c3b871"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
...
module top ;
    ...
    UART_v2_30_1 Target_UART (
        ...
        .rx_data(Net_72),
        .rx_clk(Net_73));
    defparam Target_UART.Address1 = 0;
    defparam Target_UART.Address2 = 0;
    defparam Target_UART.EnIntRXInterrupt = 0;
    defparam Target_UART.EnIntTXInterrupt = 0;
    defparam Target_UART.FlowControl = 0;
    defparam Target_UART.HalfDuplexEn = 0;
    defparam Target_UART.HwTXEnSignal = 1;
    defparam Target_UART.NumDataBits = 8;
    defparam Target_UART.NumStopBits = 1;
    defparam Target_UART.ParityType = 0;
    defparam Target_UART.RXEnable = 1;
    defparam Target_UART.TXEnable = 0;
    ...
    USBFS_v2_60_2 Launcher_UART (
        .sof(Net_85),
        .vbusdet(1'b0));

    CapSense_CSD_v3_40_5 CapSense (
        .clock(1'b0),
        .shield(Net_112),
        .vref(Net_113),
        .bclk(Net_114));

	wire [0:0] tmpOE__Target_Control_net;
	wire [0:0] tmpFB_0__Target_Control_net;
	wire [0:0] tmpIO_0__Target_Control_net;
	wire [0:0] tmpINTERRUPT_0__Target_Control_net;
	electrical [0:0] tmpSIOVREF__Target_Control_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .width(1))
		Target_Control
		 (.oe(tmpOE__Target_Control_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Target_Control_net[0:0]}),
		  .io({tmpIO_0__Target_Control_net[0:0]}),
		  .siovref(tmpSIOVREF__Target_Control_net),
		  .interrupt({tmpINTERRUPT_0__Target_Control_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Target_Control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
