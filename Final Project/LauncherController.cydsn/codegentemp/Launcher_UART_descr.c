/*******************************************************************************
* File Name: Launcher_UART_descr.c
* Version 2.60
*
* Description:
...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE Launcher_UART_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE Launcher_UART_DEVICE0_CONFIGURATION0_DESCR[67u] = {
...
*********************************************************************/
const uint8 CYCODE Launcher_UART_STRING_DESCRIPTORS[159u] = {
/*********************************************************************
...
*********************************************************************/
const uint8 CYCODE Launcher_UART_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_Launcher_UART_EP_SETTINGS_BLOCK CYCODE Launcher_UART_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[3u] = {
...
const uint8 CYCODE Launcher_UART_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[2u] = {
0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_Launcher_UART_LUT CYCODE Launcher_UART_DEVICE0_CONFIGURATION0_TABLE[5u] = {
    {0x01u,     &Launcher_UART_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &Launcher_UART_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &Launcher_UART_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_Launcher_UART_LUT CYCODE Launcher_UART_DEVICE0_TABLE[2u] = {
    {0x01u,     &Launcher_UART_DEVICE0_DESCR},
    {0x01u,     &Launcher_UART_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_Launcher_UART_LUT CYCODE Launcher_UART_TABLE[1u] = {
    {0x01u,     &Launcher_UART_DEVICE0_TABLE}
};
    ...
    *  Launcher_UART_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE Launcher_UART_MSOS_DESCRIPTOR[Launcher_UART_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   Launcher_UART_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE Launcher_UART_MSOS_CONFIGURATION_DESCR[Launcher_UART_MSOS_CONF_DESCR_LENGTH] = {
...
#endif /* Launcher_UART_ENABLE_MSOS_STRING */

/* DIE ID string descriptor for 8 bytes ID */
#if defined(Launcher_UART_ENABLE_IDSN_STRING)
    uint8 Launcher_UART_idSerialNumberStringDescriptor[Launcher_UART_IDSN_DESCR_LENGTH];
