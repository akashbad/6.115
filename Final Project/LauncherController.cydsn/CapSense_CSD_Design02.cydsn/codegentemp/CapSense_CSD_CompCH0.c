...
uint8 CapSense_CSD_CompCH0_initVar = 0u;

/* Internal functions definitoin */
static void CapSense_CSD_CompCH0_trimAdjust(uint8 nibble) ;

/* static CapSense_CSD_CompCH0_backupStruct  CapSense_CSD_CompCH0_backup; */
#if (CY_PSOC5A)
    static CapSense_CSD_CompCH0_LOWPOWER_BACKUP_STRUCT  CapSense_CSD_CompCH0_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 CapSense_CSD_CompCH0_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_Init
********************************************************************************
*
* Summary:
...
void CapSense_CSD_CompCH0_Init(void) 
{
    ...
    CapSense_CSD_CompCH0_SetSpeed(CapSense_CSD_CompCH0_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( CapSense_CSD_CompCH0_DEFAULT_HYSTERESIS == 0u )
        CapSense_CSD_CompCH0_CR |= CapSense_CSD_CompCH0_HYST_OFF;
    #else
        CapSense_CSD_CompCH0_CR &= (uint8)(~CapSense_CSD_CompCH0_HYST_OFF);
    #endif /* CapSense_CSD_CompCH0_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( CapSense_CSD_CompCH0_DEFAULT_PWRDWN_OVRD == 0u )
            CapSense_CSD_CompCH0_CR &= (uint8)(~CapSense_CSD_CompCH0_PWRDWN_OVRD);
        #else 
            CapSense_CSD_CompCH0_CR |= CapSense_CSD_CompCH0_PWRDWN_OVRD;
        #endif /* CapSense_CSD_CompCH0_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    CapSense_CSD_CompCH0_CR |= CapSense_CSD_CompCH0_MX_AO;

    /* Set default sync */
    CapSense_CSD_CompCH0_CLK &= (uint8)(~CapSense_CSD_CompCH0_SYNCCLK_MASK);
    #if ( CapSense_CSD_CompCH0_DEFAULT_BYPASS_SYNC == 0u )
        CapSense_CSD_CompCH0_CLK |= CapSense_CSD_CompCH0_SYNC_CLK_EN;
    #else
        CapSense_CSD_CompCH0_CLK |= CapSense_CSD_CompCH0_BYPASS_SYNC;
    #endif /* CapSense_CSD_CompCH0_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_Enable
********************************************************************************
*
* Summary:
...
{
    CapSense_CSD_CompCH0_PWRMGR |= CapSense_CSD_CompCH0_ACT_PWR_EN;
    CapSense_CSD_CompCH0_STBY_PWRMGR |= CapSense_CSD_CompCH0_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(CapSense_CSD_CompCH0_restoreReg == 1u)
        {
            CapSense_CSD_CompCH0_CR = CapSense_CSD_CompCH0_lowPowerBackup.compCRReg;

            /* Clear the flag */
            CapSense_CSD_CompCH0_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  CapSense_CSD_CompCH0_initVar: Is modified when this function is called for the 
...
void CapSense_CSD_CompCH0_Start(void) 
{
    ...
    if ( CapSense_CSD_CompCH0_initVar == 0u )
    {
        CapSense_CSD_CompCH0_Init();
        
        CapSense_CSD_CompCH0_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_Stop
********************************************************************************
*
* Summary:
...
void CapSense_CSD_CompCH0_Stop(void) 
{
    ...
    CapSense_CSD_CompCH0_PWRMGR &= (uint8)(~CapSense_CSD_CompCH0_ACT_PWR_EN);
    CapSense_CSD_CompCH0_STBY_PWRMGR &= (uint8)(~CapSense_CSD_CompCH0_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        CapSense_CSD_CompCH0_restoreReg = 1u;

        /* Save the control register before clearing it */
        CapSense_CSD_CompCH0_lowPowerBackup.compCRReg = CapSense_CSD_CompCH0_CR;
        CapSense_CSD_CompCH0_CR = CapSense_CSD_CompCH0_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_SetSpeed
********************************************************************************
*
* Summary:
...
void CapSense_CSD_CompCH0_SetSpeed(uint8 speed) 
{
    ...
    CapSense_CSD_CompCH0_CR = (CapSense_CSD_CompCH0_CR & (uint8)(~CapSense_CSD_CompCH0_PWR_MODE_MASK)) |
                           (speed & CapSense_CSD_CompCH0_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == CapSense_CSD_CompCH0_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            CapSense_CSD_CompCH0_TR = CapSense_CSD_CompCH0_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            CapSense_CSD_CompCH0_TR0 = CapSense_CSD_CompCH0_HS_TRIM_TR0;
            CapSense_CSD_CompCH0_TR1 = CapSense_CSD_CompCH0_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            CapSense_CSD_CompCH0_TR = CapSense_CSD_CompCH0_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            CapSense_CSD_CompCH0_TR0 = CapSense_CSD_CompCH0_LS_TRIM_TR0;
            CapSense_CSD_CompCH0_TR1 = CapSense_CSD_CompCH0_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( CapSense_CSD_CompCH0_WRK & CapSense_CSD_CompCH0_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_trimAdjust
********************************************************************************
*
* Summary:
...
static void CapSense_CSD_CompCH0_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = CapSense_CSD_CompCH0_WRK & CapSense_CSD_CompCH0_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CSD_CompCH0_TR |= CapSense_CSD_CompCH0_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CSD_CompCH0_TR0 |= CapSense_CSD_CompCH0_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CSD_CompCH0_TR |= CapSense_CSD_CompCH0_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CSD_CompCH0_TR1 |= CapSense_CSD_CompCH0_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CSD_CompCH0_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CSD_CompCH0_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CSD_CompCH0_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CSD_CompCH0_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((CapSense_CSD_CompCH0_WRK & CapSense_CSD_CompCH0_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 CapSense_CSD_CompCH0_ZeroCal(void) 
{
    ...
    tmpSW0 = CapSense_CSD_CompCH0_SW0;
    tmpSW2 = CapSense_CSD_CompCH0_SW2;
    tmpSW3 = CapSense_CSD_CompCH0_SW3;

     /* Clear routing for inP, retain routing for inN */
    CapSense_CSD_CompCH0_SW0 = 0x00u;
    CapSense_CSD_CompCH0_SW2 = 0x00u;
    CapSense_CSD_CompCH0_SW3 = tmpSW3 & (uint8)(~CapSense_CSD_CompCH0_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = CapSense_CSD_CompCH0_CR;
    CapSense_CSD_CompCH0_CR |= (CapSense_CSD_CompCH0_CAL_ON | CapSense_CSD_CompCH0_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        CapSense_CSD_CompCH0_TR = CapSense_CSD_CompCH0_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        CapSense_CSD_CompCH0_TR0 = CapSense_CSD_CompCH0_DEFAULT_CMP_TRIM;
        CapSense_CSD_CompCH0_TR1 = CapSense_CSD_CompCH0_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (CapSense_CSD_CompCH0_CR & CapSense_CSD_CompCH0_PWR_MODE_MASK) == CapSense_CSD_CompCH0_PWR_MODE_FAST)
    {
        CapSense_CSD_CompCH0_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        CapSense_CSD_CompCH0_trimAdjust(1u);
		CapSense_CSD_CompCH0_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    CapSense_CSD_CompCH0_CR = tmpCR;
    
    /* Restore routing registers for inP */
    CapSense_CSD_CompCH0_SW0 = tmpSW0;
    CapSense_CSD_CompCH0_SW2 = tmpSW2;
    CapSense_CSD_CompCH0_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) CapSense_CSD_CompCH0_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)CapSense_CSD_CompCH0_TR1 << 8u) | (CapSense_CSD_CompCH0_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: CapSense_CSD_CompCH0_LoadTrim
********************************************************************************
*
* Summary:
...
void CapSense_CSD_CompCH0_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: CapSense_CSD_CompCH0_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: CapSense_CSD_CompCH0_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
