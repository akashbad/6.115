...
**************************************/
#define PWM_INIT_PERIOD_VALUE        100u
#define PWM_INIT_COMPARE_VALUE1      10u
#define PWM_INIT_COMPARE_VALUE2      63u
#define PWM_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(0u << PWM_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << PWM_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << PWM_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(0u << PWM_STATUS_KILL_INT_EN_MASK_SHIFT )))
...
******************************** */
    ...
    ***********************************/
    ...
    #define PWM_RT1_MASK              (uint8)((uint8)0x03u << PWM_RT1_SHIFT)/* Sync TC and CMP bit masks */
    #define PWM_SYNC                  (uint8)((uint8)0x03u << PWM_RT1_SHIFT)
    #define PWM_SYNCDSI_SHIFT         0x00u
    #define PWM_SYNCDSI_MASK          (uint8)((uint8)0x0Fu << PWM_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define PWM_SYNCDSI_EN            (uint8)((uint8)0x0Fu << PWM_SYNCDSI_SHIFT) /* Sync all DSI inputs */
